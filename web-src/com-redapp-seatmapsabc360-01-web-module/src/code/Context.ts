...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-redapp-seatmapsabc360-01-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-redapp-seatmapsabc360-01-web-module/translations');
